...
(function($) {
     ...
     $.fn.tipuesearch = function(options) {
          ...
          return this.each(function() {
               ...
               //Selecting a result opens new window if setting selected
               if (set.newWindow)
               {
               ...
               //Begin search for items in search bar
               function getTipueSearch(start, replace)
               {
                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         if (c != 0)
                         {
                              ...
                              //Establish the search time taken
                              if (set.showTime)
                              {
                              ...
                              //Markup Addition - Related Search Terms 
                              ...
                              //Sort results based on score to show most accurate first
                              found.sort(function(a, b) { return b.score - a.score } );
                              
                              var l_o = 0;
                              
                              //Markup Addition - Image Zoom Modal
                              // if (set.imageZoom)
                              // {
                              //      out += '<div class="col"><div id="tipue_search_image_modal"><div class="tipue_search_image_close">&#10005;</div><div class="tipue_search_image_block"><a id="tipue_search_zoom_url"><img id="tipue_search_zoom_img"></a><div id="tipue_search_zoom_text"></div></div></div></div>';    
                              // }
                              

                              //Markup Addition - Create each valid search result
                              for (var i = 0; i < found.length; i++)
                              {
                                   if (l_o >= start && l_o < set.show + start)
                                   {
                                        ...
                                        //Markup Addition - Result Image Thumbnail
                                        if (found[i].img)
                                        {
                                             
                                             if (set.imageZoom)
                                             {
                                                  out += '<div class="d-flex flex-column mr-3"><div class="tipue_search_image"><img class="tipue_search_img tipue_search_image_zoom" src="' + found[i].img + '" alt="' + found[i].title + '" data-url="' + found[i].url + '"></div></div>';     
                                             }
                                             else
                                             {
                                                  out += '<div class="d-flex flex-column mr-3"><div class="tipue_search_image"><a href="' + found[i].url + '"' + tipue_search_w + '><img class="tipue_search_img" src="' + found[i].img + '" alt="' + found[i].title + '"></a></div></div>';
                                             }
                                        }
                                        
                                        //Markup Addition - Result Title
                                        if(found[i].img)
                                        {
                                             out += '<div class="d-flex flex-column"><div class="flex-row"><div class="tipue_search_content_title"><a href="' + found[i].url + '"' + tipue_search_w + '>' +  found[i].title + '</a></div></div>';
                                        }
                                        else {
                                             out += '<div class="d-flex flex-column css-no-img-result"><div class="flex-row"><div class="tipue_search_content_title"><a href="' + found[i].url + '"' + tipue_search_w + '>' +  found[i].title + '</a></div></div>';
                                        }
                                        ...
                                        if (set.showURL)
                                        {
                                             ...
                                             out += '<div class="tipue_search_content_date"><a href="' + found[i].date + '"' + tipue_search_w + '>' + s_u + '</a></div>';
                                        }

                                        //Markup Addition - Result Date
                                        if (found[i].date)
                                        {
                                             var s_u = found[i].date;                      
                                             out += '<div class="tipue_search_content_date"><a href="' + found[i].date + '"' + tipue_search_w + '>' + s_u + '</a></div>';
                                        }
                                        ...
                                        {                                        
                                             ...
                                             if (set.showContext)
                                             {
                                                  ...
                                                  if (s_1 > set.contextStart)
                                                  {
                                                       ...
                                                       //Adds three dots if description is longer than allowed
                                             ...
                                             //Adds three dots if description is longer than waht is allowed
                                             ...
                                             //Markup Addition - Result Description
                                             if(found[i].img)
                                             {
                                                  out += '<div class="flex-row"><div class="tipue_search_content_text">' + t_d + '</div></div></div>';
                              ...
                              if (c > set.show)
                              {
                                   ...
                                   //Footer Left Arrow Display
                                   if (start > 0)
                                   {
                                       out += '<li role="navigation"><a class="tipue_search_foot_box" id="' + (start - set.show) + '_' + replace + '">' + tipuesearch_string_6 + '</a></li>'; 
                                   }
                                   ...
                                   if (page + 1 != pages)
                                   {
                                       out += '<li role="navigation"><a class="tipue_search_foot_box" id="' + (start + set.show) + '_' + replace + '">' + tipuesearch_string_7 + '</a></li>'; 
                                   }                    
                    ...
                    $('#tipue_search_content').hide().html(out).slideDown(10);
